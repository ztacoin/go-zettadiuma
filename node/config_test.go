...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gzta.ipc", false, filepath.Join(os.TempDir(), "gzta.ipc")},
		{"data", "gzta.ipc", false, "data/gzta.ipc"},
		{"data", "./gzta.ipc", false, "./gzta.ipc"},
		{"data", "/gzta.ipc", false, "/gzta.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gzta.ipc", true, `\\.\pipe\gzta.ipc`},
		{"data", "gzta.ipc", true, `\\.\pipe\gzta.ipc`},
		{"data", `\\.\pipe\gzta.ipc`, true, `\\.\pipe\gzta.ipc`},
	}
