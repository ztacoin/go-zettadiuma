Name "gzta ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/ztacoin/go-zettadiuma/issues"
!define UPDATEURL "https://github.com/ztacoin/go-zettadiuma/releases"
!define ABOUTURL "https://github.com/ztacoin/go-zettadiuma#ethereum-go"
...
# Install gzta binary
Section "Gzta" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Gzta}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gzta.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gzta.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gzta incoming peers (TCP:28120)"
  SimpleFC::AdvRemoveRule "Gzta outgoing peers (TCP:28120)"
  SimpleFC::AdvRemoveRule "Gzta UDP discovery (UDP:28120)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gzta incoming peers (TCP:28120)" ""  6 1 1 2147483647 1 "$INSTDIR\gzta.exe" "" "" "Ethereum" 28120 "" "" ""
  SimpleFC::AdvAddRule "Gzta outgoing peers (TCP:28120)" ""  6 2 1 2147483647 1 "$INSTDIR\gzta.exe" "" "" "Ethereum" "" 28120 "" ""
  SimpleFC::AdvAddRule "Gzta UDP discovery (UDP:28120)" "" 17 2 1 2147483647 1 "$INSTDIR\gzta.exe" "" "" "Ethereum" "" 28120 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gzta.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gzta.ipc"
