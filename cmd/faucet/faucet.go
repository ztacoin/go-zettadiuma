...
import (
	...
	"github.com/ztacoin/go-zettadiuma/ethclient"
...
var (
	...
	ethPortFlag = flag.Int("ethport", 28120, "Listener port for the devp2p connection")
...
func (f *faucet) apiHandler(conn *websocket.Conn) {
	...
	for {
		...
		default:
			err = errors.New("Something funky happened, please open an issue at https://github.com/ztacoin/go-zettadiuma/issues")
		}
		if err != nil {
			if err = sendError(conn, err); err != nil {
